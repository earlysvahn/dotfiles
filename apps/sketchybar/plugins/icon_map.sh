...
function __icon_map() {
  ...
  "Calculator" | "Calculette")
    ...
    ;;
  "Calendar" | "??" | "Fantastical" | "Cron" | "Amie" | "Calendrier" | "Notion Calendar")
  ...
  "Fusion")
    icon_result=":fusion:"
    ;;
  "System Preferences" | "System Settings" | "????" | "R�glages Syst�me")
    icon_result=":gear:"
    ;;
  "GitHub Desktop")
    icon_result=":git_hub:"
  ...
  "Logseq")
    icon_result=":logseq:"
    ;;
  "Canary Mail" | "HEY" | "Mail" | "Mailspring" | "MailMate" | "Superhuman" | "Spark" | "??")
    icon_result=":mail:"
    ;;
  "MAMP" | "MAMP PRO")
    icon_result=":mamp:"
